...
import com.dev.hari.trackme.TrackerApplication;
...
public class TinyDB implements MyConstants {

    private SharedPreferences preferences, mPref;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    private static TinyDB instance = new TinyDB();
...
//        preferences = PreferenceManager.getDefaultSharedPreferences(appContext);
        preferences = TrackerApplication.appContext.getSharedPreferences(PREF_TRACKER_APP, Context.MODE_PRIVATE);
    }
