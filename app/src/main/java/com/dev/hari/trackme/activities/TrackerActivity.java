...
import com.dev.hari.trackme.services.TrackerService;
import com.dev.hari.trackme.utility.Utilities;
...
public class TrackerActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utilities.disableVisible(mEmailEditText, mPasswordEditText);

        String mobileNumber = db.getString(PREF_MOBILE_NUMBER);
        mTransportIdEditText.setText(mobileNumber);
...
//                transportID.length() > 0 && email.length() > 0 && password.length() > 0) {
...

    {
        ...
        mTransportIdEditText.setText(getString(R.string.transport_id));
        mEmailEditText.setText(getString(R.string.email));
        mPasswordEditText.setText(getString(R.string.password));
    }
...
//        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSwitch.setEnabled(db.getString(PREF_MOBILE_NUMBER).length() > 0);
